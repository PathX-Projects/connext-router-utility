...
if __name__ == "__main__":
    ...
    private_key = cPrompt("\nEnter the private key of the wallet that you'd like to use for your Router. It is advisable that you create a fresh wallet for the router: ")
